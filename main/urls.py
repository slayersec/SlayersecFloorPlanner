...
urlpatterns = [
    ...
    path("checkcred", views.login, name="checkcred"),
    path("config", views.login, name="config"),
    path("checkcred2", views.login, name="checkcred2"),
    path("registerLogic", views.login, name="registerLogic"),
